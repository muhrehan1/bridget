<?php
/*
 * Template Name: Rejected Vendor Listing
 */
...
<head>
    ...
    <title>Rejected Vendor Management - Bridget Harris</title>
                            ...
                            <tbody>
                                <?php   
                                    ...
                                    foreach($getusers as $key => $getuser){
                                        ...
                                        if($getuser->ID != 1 &&  $getuser->roles[0] == 'um_rejected-vendor'){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions">
                                            <a href="<?php echo home_url(); ?>/rejected-vendor-profile/?vendor_id=<?php echo $getuser->ID; ?>" class="edit"><img src="<?php echo get_template_directory_uri(); ?>/inc/bridget-data/assets/images/eye.png"></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php  
